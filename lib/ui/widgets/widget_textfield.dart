            ...
            child: Stack(
              children: [
                ...
                TextFormField(
                  ...
                  style: TextStyle(
                    color: widget.textColor ?? R.color.gray.shade900,
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(
                      color: widget.labelTextColor ?? R.color.gray.shade500,
                      fontSize: 16.0,
  ...
  OutlineInputBorder _getErrorBorder() {
    return OutlineInputBorder(
      borderSide: BorderSide(
        color: widget.errorBorderColor ?? R.color.error,
        width: 1.0,
      ),
      borderRadius: BorderRadius.circular(widget.radius),
    );
