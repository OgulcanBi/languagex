import 'package:languagex/core/constant/constant_sort.dart';

import '../constant/constant_expense_status.dart';
...
class R {
  static void refreshClass() {
    ...
    _string = null;
    _dimens = null;
    ConstantSort.refresh();
    ConstantExpenseStatus.refresh();
  }
