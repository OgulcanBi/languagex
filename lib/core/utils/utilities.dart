...
class Alerts {
  ...
  void showSuccessSnackBar(GlobalKey<ScaffoldState> scaffoldKey, String value, bool isSuccess) {
    ScaffoldMessenger.of(scaffoldKey.currentContext!).showSnackBar(SnackBar(
      content: Row(
        children: [
          isSuccess ? SvgPicture.asset(R.drawable.svg.approvementSuccess) : Icon(Icons.cancel_outlined, color: R.color.error.shade900),
          SizedBox(width: 10),
          Text(value),
        ],
      ),
